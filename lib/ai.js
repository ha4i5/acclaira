...
export async function generate(userId, prompt, maxTokens = 1200) {
  ...
  if (gemini) {
    // Uses Google's latest high-speed Gemini Flash engine
  ...
  throw new Error("No AI key configured. Add your Gemini API key in Settings → AI engines or set GEMINI_API_KEY in .env.");
}
